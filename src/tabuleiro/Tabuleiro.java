...
public class Tabuleiro {
	...
	public Tabuleiro(int linhas, int colunas) {
		...
		if (linhas < 1 || colunas < 1) {
			throw new TabuleiroExceptions(
					"Erro ao criar o tabuleiro, e necessário ter pelo menos 1 linha e uma coluna.");
		}
	...
	public Peca peca(int linha, int coluna) {
		if (!posicaoExistente(linha, coluna)) {
			throw new TabuleiroExceptions("Posicao fora do tabuleiro!");
		}
	...
	public void alocarPeca(Peca peca, Posicao posicao) {
		if (temUmaPeca(posicao)) {
			throw new TabuleiroExceptions("Existe uma peca na posicao " + posicao + ".");
		}
	...
	/*
	 * COMPLEMENTO DO PRÓXIMO MÉTODO, RETORNA UMA CONDIÇÃO V OU F CASO A LINHA OU
	 * COLUNA INFORMADA SEJA DIFERENTE DO TAMANHO DO TABULEIRO, RETORNARÁ FALSO.
	 * 
